...
def play_freetime(steps, wraparound, randstart, Q, alpha, eps, discount, alpha2):
    ...
    F = np.ones((grid_wrold.rows,grid_wrold.col,1,3))
    #F =  np.zeros((grid_wrold.rows,grid_wrold.col,1,3))
